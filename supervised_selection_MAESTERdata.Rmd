...
AD_mtx <- ReadMtx(
  mtx = "/home/linxy29/data/maester/maester_paper/bpdcn712/manual_pipeline/maester_cellSNP0/cellSNP.tag.AD.mtx", features = "/home/linxy29/data/maester/maester_paper/bpdcn712/manual_pipeline/maester_cellSNP0/cellSNP.variants.tsv",
  cells = "/home/linxy29/data/maester/maester_paper/bpdcn712/manual_pipeline/maester_cellSNP0/cellSNP.samples.tsv", feature.column = 1)
DP_mtx <- ReadMtx(
  mtx = "/home/linxy29/data/maester/maester_paper/bpdcn712/manual_pipeline/maester_cellSNP0/cellSNP.tag.DP.mtx", features = "/home/linxy29/data/maester/maester_paper/bpdcn712/manual_pipeline/maester_cellSNP0/cellSNP.variants.tsv",
  cells = "/home/linxy29/data/maester/maester_paper/bpdcn712/manual_pipeline/maester_cellSNP0/cellSNP.samples.tsv", feature.column = 1)
...
```{r}
sample_DP = subset_DP[2800:2900, 2800:2900]
sample_AD = subset_AD[2800:2900, 2800:2900]
...
base_path <- "/home/linxy29/data/maester/maester_paper/k562_bt142/maester/mquad_pipeline/maester_cellSNP001"
...
```{r}
cell_wClone = read_csv("/home/linxy29/data/maester/maester_paper/k562_bt142/cell_label_full.csv")
```
...
saveRDS(res, file = "/home/linxy29/data/maester/maester_paper/k562_bt142/variant_selection/fixed_effect/supervised_glm_pval.rds")
```
